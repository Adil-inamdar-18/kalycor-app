...
import { workforceCta } from "@/data/solutions/workforceSolutions";
        ...
        <div className="overflow-hidden rounded-3xl bg-[#141A32] px-7 py-12 text-white md:px-12 md:py-16 lg:px-16">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              >
                {workforceCta.primaryLabel}
              </Link>

              <Link
                href={workforceCta.secondaryHref}
