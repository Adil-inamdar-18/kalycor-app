...
import { customizedCta } from "@/data/solutions/customizedSolutions";

export default function CustomizedCta() {
  return (
      ...
      <Container>
        <div className="rounded-3xl bg-[#141A32] px-6 py-14 text-center text-white sm:px-10 md:py-20 lg:px-16">
          ...
          <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              href={customizedCta.primaryHref}
            ...
            >
              {customizedCta.primaryLabel}
            </Link>

            <Link
              href={customizedCta.secondaryHref}
