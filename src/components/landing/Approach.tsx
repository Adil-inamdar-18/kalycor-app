...
export function Approach() {
  ...
  return (
    ...
    >
      <div
        className="
          relative mx-auto flex max-w-[1280px] flex-col gap-[22px] px-6
          tp:block tp:min-h-[760px] tp:px-0
          tp:before:pointer-events-none
          tp:before:absolute
          tp:before:left-1/2
          tp:before:top-[-110px]
          tp:before:h-[300px]
      ...
      >
        ...
        <div
          className="
            relative z-[3] order-1 w-full text-center
            tp:absolute tp:left-1/2 tp:top-[245px]
            tp:w-[54vw] tp:-translate-x-1/2
            dl:top-[250px]
            dl:w-[min(760px,58vw)]
          "
        >
