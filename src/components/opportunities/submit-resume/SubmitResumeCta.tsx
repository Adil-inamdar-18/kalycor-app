...
import { submitResumeCta } from "@/data/opportunities/submitResume";

export default function SubmitResumeCta() {
  return (
      ...
      <Container>
        ...
        >
          ...
          <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            >
              {submitResumeCta.primaryLabel}
            </Link>

            <Link
              href={submitResumeCta.secondaryHref}
            ...
            >
              {submitResumeCta.secondaryLabel}
            </Link>
          </div>
        </div>
      </Container>
