...
import { globalTalentCenterHero } from "@/data/opportunities/globalTalentCenter";

export default function GlobalTalentCenterHero() {
  return (
    <section className="relative isolate min-h-[560px] overflow-hidden">
      <Image
        src={globalTalentCenterHero.image}
        alt={globalTalentCenterHero.imageAlt}
        fill
        priority
