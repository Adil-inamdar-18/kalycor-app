...
import { referralProgramHero } from "@/data/opportunities/referralProgram";

export default function ReferralProgramHero() {
  return (
    <section className="relative isolate min-h-[560px] overflow-hidden">
      <Image
        src={referralProgramHero.image}
        alt={referralProgramHero.imageAlt}
        fill
        priority
