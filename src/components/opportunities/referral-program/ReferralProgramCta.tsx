...
import { referralProgramCta } from "@/data/opportunities/referralProgram";

export default function ReferralProgramCta() {
  return (
    <section className="bg-background py-20 md:py-28">
      <Container>
        <div
          id="referral-form"
          className="rounded-3xl bg-[#141A32] px-6 py-14 text-center text-white sm:px-10 md:py-20 lg:px-16"
        >
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-[#e9c176]">
            {referralProgramCta.kicker}
          </p>

          <h2 className="mx-auto max-w-3xl text-3xl font-semibold leading-tight md:text-4xl lg:text-5xl">
            {referralProgramCta.heading}
          </h2>

          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/70 md:text-lg">
            {referralProgramCta.body}
          </p>

          <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              href={referralProgramCta.primaryHref}
            ...
            >
              {referralProgramCta.primaryLabel}
            </Link>

            <Link
              href={referralProgramCta.secondaryHref}
            ...
            >
              {referralProgramCta.secondaryLabel}
            </Link>
          </div>
        </div>
      </Container>
