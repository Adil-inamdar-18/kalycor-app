...
import { opportunitiesHero } from "@/data/opportunities/opportunities";

export default function OpportunitiesHero() {
  return (
    <section className="relative isolate min-h-[560px] overflow-hidden">
      <Image
        src={opportunitiesHero.image}
        alt={opportunitiesHero.imageAlt}
        fill
        priority
