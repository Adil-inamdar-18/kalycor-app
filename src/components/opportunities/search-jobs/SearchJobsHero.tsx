...
import { searchJobsHero } from "@/data/opportunities/searchJobs";

export default function SearchJobsHero() {
  return (
    <section className="relative isolate min-h-[560px] overflow-hidden">
      <Image
        src={searchJobsHero.image}
        alt={searchJobsHero.imageAlt}
        fill
        priority
