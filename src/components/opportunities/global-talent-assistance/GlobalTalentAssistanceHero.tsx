...
import { globalTalentAssistanceHero } from "@/data/opportunities/globalTalentAssistance";

export default function GlobalTalentAssistanceHero() {
  return (
    <section className="relative isolate min-h-[560px] overflow-hidden">
      <Image
        src={globalTalentAssistanceHero.image}
        alt={globalTalentAssistanceHero.imageAlt}
        fill
        priority
