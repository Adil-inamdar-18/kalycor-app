...
import { globalTalentAssistanceCta } from "@/data/opportunities/globalTalentAssistance";

export default function GlobalTalentAssistanceCta() {
  return (
      ...
      <Container>
        <div className="rounded-3xl bg-[#141A32] px-6 py-14 text-center text-white sm:px-10 md:py-20 lg:px-16">
          ...
          <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            >
              {globalTalentAssistanceCta.primaryLabel}
            </Link>

            <Link
              href={globalTalentAssistanceCta.secondaryHref}
            ...
            >
              {globalTalentAssistanceCta.secondaryLabel}
            </Link>
          </div>
        </div>
      </Container>
