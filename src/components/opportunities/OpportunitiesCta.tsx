...
import { opportunitiesCta } from "@/data/opportunities/opportunities";
      ...
      <Container>
        <div className="rounded-3xl bg-[#141A32] px-6 py-14 text-center text-white sm:px-10 md:py-20 lg:px-16">
          ...
          <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            >
              {opportunitiesCta.primaryLabel}
            </Link>

            <Link
              href={opportunitiesCta.secondaryHref}
            ...
            >
              {opportunitiesCta.secondaryLabel}
            </Link>
          </div>
        </div>
      </Container>
