/**
 * All six solutions pages share the landing page's visual theme, so this
 ...
 * which is what let their --primary token fall back to the root default
 * (a lighter navy) instead of matching the rest of the site.
 */
